...
const PAGE_NAME_UPPER_CAMEL_CASE: FC<PAGE_NAME_UPPER_CAMEL_CASEProps> = () => {
  ...
  const menu = (
    <Menu>
      <Menu.Item>{`${useIntl().formatMessage({ id: 'app.pwa.dashboard.Operation one' })}`}</Menu.Item>
      <Menu.Item>{`${useIntl().formatMessage({ id: 'app.pwa.dashboard.Operation two' })}`}</Menu.Item>
    </Menu>
  );
